<%-- 
    ...
    Created on : 4/05/2022, 06:46:36 PM
    Author     : crist
--%>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class=" myContainerAbs col-md-10  hidden-sm">
                            <form>
                                ...
                                <div class="col-md-8">
                                    <input type="number" class="form-control myInput" placeholder="ID" aria-describedby="basic-addon1" required>
                                ...
                                <div class="col-md-8">
                                    <button type="submit" class="btnReg btn-default form-control myButton">Actualizar</button>
                                </div>
                            </form>
                        </div>
