<%-- 
    Document   : productoComentario
    Created on : 4/05/2022, 06:52:45 PM
    Author     : carmi
--%>
         ...
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                  <li><a class="buy" href="login.jsp">Salir</a></li>
               </div>
            </div>
         </div>
         <!-- end header inner --> 
   ...
   <div class="container">
      <div class="row">
         <dir class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
          ...
          <dir class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
            <div class="about_box">
               <h3>Computadora Interactiva para Niños y Niñas</h3>
               <p>Se convierte en Tablet </p>
               <p>Cuenta con 5 modos de aprendizaje</p>
               <p>Perfecto para el aprendizaje de los pequeños</p>
               <p>La computadora portátil 2 en 1 cuenta con 
                    una pantalla que se voltea para convertir del modo teclado al
                    modo tableta. La computadora portátil cuenta con un teclado
                    con letras A-Z y números del 1 al 10, o gírelo y transfórmelo
                    en una tableta táctil. Los niños pueden fingir ser como mamá 
                    y papá con actividades de juego de roles como enviar correos 
                    electrónicos a Scout.</p>
            </div>
         </dir> 
      </div>
   </div>
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="container">
              <div class="carousel-caption text-bg">
               <div class="img_bg">
                  <i><img src="images/jotape.png"/><span>JP Valenzuela<br><strong class="date">04/05/2022</strong></span></i>
                  
               </div>
                  <div class="img_bg">
                   <br>
                <p>Está bien chila. ¡Wow!<br>
                Recomiendo </p>
               </div>
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="carousel-caption text-bg">
                <div class="img_bg">
                  <i><img src="images/pristina.png"/><span>Cristinita Aguilar<br><strong class="date">04/05/2022</strong></span></i>
          ...
          <div class="carousel-item">
            <div class="container">
              <div class="carousel-caption text-bg">
                 <div class="img_bg">
                  <i><img src="images/carminamog.png"/><span>Carminamog<br><strong class="date">04/05/2022</strong></span></i>
