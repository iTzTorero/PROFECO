...
// Model for Usuario entity
    models.Usuario = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/ESBPROFECO/webresources/usuario/",
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:8080/ESBPROFECO/webresources/usuario/';
            }
    ...
    models.UsuarioCollection = Backbone.Collection.extend({
        ...
        url: "http://localhost:8080/ESBPROFECO/webresources/usuario/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
